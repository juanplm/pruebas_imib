...
### Mantenemos unicamente las variables presenten en el mejor modelo generado con RFE
resultado_rfe = readRDS("rfe_rf_9010_prop1")
df_modificado_reducido = df_reducido[,c(predictors(resultado_rfe),"patologia_principal")]

set.seed(1234)
particion = createDataPartition(df_modificado_reducido$patologia_principal, p=0.9, list = FALSE)

train_data = df_modificado_reducido[particion,]
test_data = df_modificado_reducido[-particion,]
...
saveRDS(modelos.svm.lineal, "modelos_2fenotipos_svml_9010_prop1_rf")
...
saveRDS(modelos.svm.radial, "modelos_2fenotipos_svmr_9010_prop1_rf")
...
saveRDS(modelos.svm.polinomial, "modelos_2fenotipos_svmp_9010_prop1_rf")
...
saveRDS(modelos.rf, "modelos_2fenotipos_rf_9010_prop1_rf")
...
saveRDS(modelos.nb, "modelos_2fenotipos_nb_9010_prop1_rf")
